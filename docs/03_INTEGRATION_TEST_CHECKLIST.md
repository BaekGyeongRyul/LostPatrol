...
| 5 | Web에서 **PATROL START** 클릭 | 라인트레이싱 자동순찰이 시작됨 | 이윤정 | ☑ (2026.08.26 실물로 확인 — 웹 PATROL START → 라인 따라 정상 주행, 이탈 시 스스로 보정) |
| 6 | Web에서 **PATROL STOP** 클릭 | 자동순찰이 종료되고 정지 상태로 전환 | 이윤정 | ☑ (2026.08.26 실물로 확인) |
...
| 9 | 자동순찰 중 초음파 센서로 장애물 감지 | 설정된 거리 이내 장애물 발견 시 로봇이 **안전 정지** (회피 아님) | 이윤정 | ☑ (2026.08.26 실물로 확인 — 순찰 중 20cm 이내 장애물에서 즉시 안전 정지) |
